...
export declare function getSymKeypoints(keypoints: Keypoint[], minConfidence: number): Keypoint[][];
export declare function getAngleKeyPoints(keypoints: Keypoint[], minConfidence: number): Keypoint[][];
...
export declare function getInputTensorDimensions(inputVal: PosenetInput): [number, number];
